...
/*
? Function Components:
 Defined as functions that return HTML via JSX. They are simpler compared to class components and are preferred for modern React development,
  especially with the introduction of hooks in React 16.8.

? Props:
 Short for properties, props are how you pass data and event handlers down to child components. 
 In this example, Car receives a color prop to dynamically define its display.

? Rendering Components:
 Demonstrates how to render a component within another component (Car inside Garage) and how to mount the top-level component (Garage) into the 
 DOM using ReactDOM.
...
? React Fragments:
 Used in the Garage component to group multiple elements without adding extra nodes to the DOM, which is helpful for CSS styling, 
