...
function Events() {
  ...
  return (
    <form onSubmit= {handleSubmit} >
      ...
      <button type="submit" onMouseOver={handleMouseOver}> Submit </button>
    </form>
  );
}
...
but there are some syntax differences and specific behaviors you need to be aware of. 
...
It prevents the default browser form submission behavior (which reloads the page) using event.preventDefault(), 
and then it can handle the submission logic, like sending data to a server or processing it within the app.
